...
public class ExcelUtility {
        ...
        public static List<String> readDataFromExcel(String sheetName) {
            ...
            try (FileInputStream f = new FileInputStream(System.getProperty("user.dir") + Constants.TESTDATA_EXCEL_PATH);
        ...
        public static List<List<String>> excelDataReader(String sheetName) {
            ...
            DataFormatter formatter = new DataFormatter();
            try {
                f = new FileInputStream(System.getProperty("user.dir") + Constants.TESTDATA_EXCEL_PATH);
